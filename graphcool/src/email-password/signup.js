...
exports.default = function (event) { return __awaiter(_this, void 0, void 0, function () {
    var graphcool, api, _a, email, password, name_1, userExists, salt, hash, userId, token, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                _a = event.data, email = _a.email, password = _a.password, name_1 = _a.name;
            ...
            case 3:
                hash = _b.sent();
                return [4 /*yield*/, createGraphcoolUser(api, email, hash, name_1)
